...
class TerritoryController extends Controller
{
    ...
    {
        $this->middleware('permission:wilayah.lihat|wilayah.show', [
            'only' => ['index', 'show']
        ]);
        $this->middleware('permission:wilayah.tambah', [
            'only' => ['store']
        ]);
        $this->middleware('permission:wilayah.ubah', [
            'only' => ['update']
        ]);
        $this->middleware('permission:wilayah.hapus', [
            'only' => ['destroy']
        ]);
        $this->model = $model;
    }
