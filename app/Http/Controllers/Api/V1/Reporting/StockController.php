...
class StockController extends Controller
{
    ...
    {
        $this->middleware('permission:histori-stok.lihat', [
            'only' => ['index']
        ]);
    }
    ...
    {
        $data = StockService::getAll($request);
    ...
    public function export(Request $request)
    {
        ...
        $fileName = 'history stock-' . $startDate . '-' . rand(0, 1000) . '.csv';
        return Excel::download(new Stock($startDate, $branchIds, $endDate), $fileName);
    }
}
