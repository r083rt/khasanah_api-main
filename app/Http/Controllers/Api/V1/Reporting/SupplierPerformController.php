...
use App\Exports\Reporting\SupplierPerformExport;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use App\Models\Purchasing\PoSupplier;
use Maatwebsite\Excel\Facades\Excel;

class SupplierPerformController extends Controller
{
    protected $model;
    /**
    ...
    {
        $this->middleware('permission:performa-supplier.lihat', [
            'only' => ['index']
        ]);
        $this->model = $model;
    }
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(new SupplierPerformExport($month, $year), $fileName);
    }
}
