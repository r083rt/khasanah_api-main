...
class MenuHistoryRetur extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'menu:history-retur';
     ...
     * @var string
     */
    protected $description = 'Create Menu History Retur';
    ...
    public function handle()
    {
        $data = [
            [
                'title' => "History Retur & Sumbangan",
                'parent_id' => null,
                'classification' => 'central_report',
                'icon' => 'cast_connected',
                'url' => '/reporting/history-return',
                'type' => 'item',
                'order_menu' => 8,
                'is_displayed' => 1,
                'permissions' => [
