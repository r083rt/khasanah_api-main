...
class MenuReportTransaction extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'menu:report-transaction';
     ...
     * @var string
     */
    protected $description = 'Create Menu Report Transaction';
    ...
    public function handle()
    {
        $data = [
            [
                ...
                'icon' => 'assistant',
                'url' => '/reporting/report-transaction',
                'type' => 'item',
                'order_menu' => 12,
                'is_displayed' => 1,
                'permissions' => [
