...
class MenuHistoryMutasiStock extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'menu:history-mutasi-stock';
     ...
     * @var string
     */
    protected $description = 'Create Menu History Mutasi Stock';
    ...
    public function handle()
    {
        $data = [
            [
                'title' => "History Mutasi Stok",
                'parent_id' => null,
                'classification' => 'central_report',
                'icon' => 'legend_toggle',
                'url' => '/reporting/mutasi-stock',
                'type' => 'item',
                'order_menu' => 7,
                'is_displayed' => 1,
                'permissions' => [
                    [
                        'name' => 'Lihat',
                        'action' => 'histori-mutasi-stok.lihat',
                    ]
                ]
            ]
        ];
