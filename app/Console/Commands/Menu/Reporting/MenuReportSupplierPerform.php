...
class MenuReportSupplierPerform extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'menu:supplier-perform';
     ...
     * @var string
     */
    protected $description = 'Create Menu Supplier Perform';
    ...
    public function handle()
    {
        $data = [
            [
                ...
                'icon' => 'bookmark_added',
                'url' => '/reporting/supplier-perform',
                'type' => 'item',
                'order_menu' => 14,
                'is_displayed' => 1,
                'permissions' => [
                    [
                        'name' => 'Lihat',
                        'action' => 'performa-supplier.lihat',
                    ],
                ]
            ]
        ];
