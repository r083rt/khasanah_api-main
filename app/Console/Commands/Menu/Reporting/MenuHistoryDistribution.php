...
class MenuHistoryDistribution extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'menu:history-distribution';
     ...
     * @var string
     */
    protected $description = 'Create Menu History Distribution';
        ...
        $data = [
            [
                ...
                'permissions' => [
                    [
                        'name' => 'Lihat',
                        'action' => 'histori-distribusi.lihat',
                    ]
                ]
            ]
        ];
