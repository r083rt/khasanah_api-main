...
class MenuApprovalForecastConversion extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'menu:approval-forecast-conversion';
     ...
     * @var string
     */
    protected $description = 'Create Menu Approval Forecast Conversion';
    ...
    public function handle()
    {
        $data = [
            [
                'title' => "Approval Konversi Forecast",
                'parent_id' => null,
                ...
                'permissions' => [
                    [
                        'name' => 'Lihat',
                        'action' => 'approval-konversi-forecast.lihat',
                    ],
                    [
                        'name' => 'Ubah',
                        'action' => 'approval-konversi-forecast.ubah',
                    ]
                ]
            ]
        ];
        ...
        foreach ($data as $value) {
            ...
            if ($menu) {
                ...
                foreach ($value['permissions'] as $row) {
                    $permission = $menu->permissions()->where('name', $row['name'])->update($row);
                }
            } else {
