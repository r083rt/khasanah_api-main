...
class ForecastConversionSettingPoQtySupplier extends Model
{
    use HasFactory;
    use ColumnFilterer;
    use ColumnSorter;
     ...
     */
    public function forecastConversionSettingPoSupplierQtyDeliveries()
    {
        return $this->hasMany(ForecastConversionSettingPoSupplierQtyDelivery::class, 'forecast_conversion_setting_po_supplier_id', 'id');
    }
