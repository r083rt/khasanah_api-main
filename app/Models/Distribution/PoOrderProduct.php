...
class PoOrderProduct extends Model
{
    ...
    protected static function booted()
    {
        static::creating(function ($user) {
            ...
            $user->nomor_po = date('YmdHis') .  $branch_id;
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeBrownies($query)
    {
        $query->where('type', 'brownies');
    }
    ...
    public function getAvailableStatusAttribute()
    {
        switch ($this->status) {
            ...
            case 'processed':
                return ['product_accepted', 'product_rejected'];
                break;

            case 'product_rejected':
                return ['product_accepted'];
                break;
            ...
            case 'print':
                return ['product_incomplete', 'done'];
                break;
    ...
    /**
     * Get the created date indo attribute.
     *
     * @return integer
     */
   ...
   /**
    * Get the branch_id for the po order product.
    */
    ...
    /**
     * Get the details for the po order product.
     */
    public function details()
    {
        return $this->hasMany(PoOrderProductDetail::class);
    }
    ...
    {
        return $this->hasMany(PoOrderProductStatusLog::class);
    }
    ...
    {
        return $this->hasMany(PoOrderProductPackaging::class);
    }
    ...
    {
        return $this->hasMany(PoOrderProductNote::class);
    }
}
